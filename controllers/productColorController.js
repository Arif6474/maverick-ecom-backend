...
const createProductColor = asyncHandler(async (req, res) => {
    await createDocument({ model: ProductColor, req, res, folderName: 'images/productColor' });
})

const updateProductColor = asyncHandler(async (req, res) => {
    await updateDocument({ model: ProductColor, req, res, folderName: 'images/productColor' });
});

const deleteProductColor = asyncHandler(async (req, res) => {
    await deleteDocument({ model: ProductColor, req, res, fileFields: ['image'] });
});
